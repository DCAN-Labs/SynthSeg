...
def correct_chirality_for_fold(nifti_input_folder_pth, images_ts_folder, nifti_output_folder):
    data_folder = '../../../../data'
...
if __name__ == '__main__':
    ...
    correct_chirality_for_fold(nifti_input_folder_dir, imagesTsFolder, nifti_output_dir)
